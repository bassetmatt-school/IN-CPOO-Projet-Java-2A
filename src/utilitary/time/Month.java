...
public enum Month {
	JANUARY (0, 31, 31), FEBRUARY(1, 28, 59), MARCH(2, 31, 90), APRIL(3, 30, 120), MAY(4, 31, 151), JUNE(5, 30, 181),
	JULY(6, 31, 212), AUGUST(7, 31, 243), SEPTEMBER(8, 30, 273), OCTOBER(9, 31, 304), NOVEMBER(10, 30, 334),
	DECEMBER(11, 31, 365);
